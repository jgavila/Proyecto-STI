<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeearchCG.aspx.cs" Inherits="Proyecto_STI.SeearchCG" %>
    ...
    <div class="template-page-wrapper">
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          ...
          <h1>Costo - Gastos Adicionales</h1>
          <p>En esta sección puede ver los Costos y Gastos Adicionales</p>

          <div class="row">
              <div class="col-md-12">
                    <div class="panel panel-info">
                      <div class="panel-heading">Escoja el rango de fecha (Esta es la fecha de registro del Costo - Gasto), luego precione el boton mostrar</div>
                    </div>
              </div>
          </div> 
         <div class="row">
